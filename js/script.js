...
function lastButton() {
    if (!termsCheck.checked) {
        ...
        document.querySelector('#total-time').innerHTML = `Your shopping process took: <strong>${minutesShopping} minutes ${secondsShopping} seconds</strong>`;
    }
}
...
function timer() {
    ...
    interval = setInterval(function() {
        ...
        document.querySelector("#minutes-shopping ").textContent = `${cont} minutes ago.`;
        if (cont === 5) {
            location.reload();
        }
    }, 10000);
